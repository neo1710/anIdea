...
export default function EnhancedNavbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-gray-300 to-gray-400 shadow-lg relative">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0">
            <span className="text-2xl font-bold text-gray-800 tracking-wide hover:text-gray-700 transition-colors duration-300 cursor-pointer">
              Ornaments
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {navItems.map((item, index) => (
              ...
              <Button
                ...
                className="group relative flex items-center gap-2 px-4 py-2 !bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-md active:scale-95 overflow-hidden"
              >
          ...
          <div className="md:hidden">
            <Button
              ...
              className="p-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-all duration-300 transform hover:scale-110 active:scale-95"
            >
              {isMobileMenuOpen ? (
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-2 bg-gray-200 rounded-b-lg shadow-inner">
            {navItems.map((item, index) => (
              <Button
                key={index}
                className="group w-full flex items-center gap-3 px-4 py-3 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg transition-all duration-300 transform hover:translate-x-2 hover:shadow-md active:scale-95"
                style={{
